...
if __name__ == '__main__':
    ...
    detect_model.load_state_dict(
        torch.load(str(PACKAGE_ROOT / "Weights" / "MobileFace_Net"), map_location=lambda storage, loc: storage)
    )
    ...
    while True:
        ...
        if isSuccess:
            try:
                ...
                font = ImageFont.truetype(str(PACKAGE_ROOT / 'utils' / 'simkai.ttf'), 30)
